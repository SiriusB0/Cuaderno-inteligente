...
class StudyView {
    ...
    showTextEditor(page) {
        ...
        if (this.textEditor) {
            ...
            requestAnimationFrame(() => {
                setTimeout(() => {
                    // Restaurar bloques de código con CodeMirror
    ...
    oldCodeBlockStylesForReference() {
        // Mantener por si acaso, pero no se llama
        if (document.getElementById('code-block-styles')) return;
        
        const styleTag = document.createElement('style');
        styleTag.id = 'code-block-styles-old';
        styleTag.textContent = `
            ...
            /* Opciones del dropdown también en dark mode */
            ...
            /* ===== Estilos de CodeMirror (Dracula Theme) ===== */
            ...
            /* Dracula theme override para consistencia */
            .code-block-wrapper .cm-s-dracula.CodeMirror {
                background: #282a36 !important;
                color: #f8f8f2 !important;
            }
            
            .code-block-wrapper .cm-s-dracula .CodeMirror-gutters {
                background: #282a36 !important;
                border-right: 1px solid #44475a !important;
            }
            
            .code-block-wrapper .cm-s-dracula .CodeMirror-linenumber {
                color: #6272a4 !important;
            }
            
            .code-block-wrapper .cm-s-dracula .CodeMirror-cursor {
                border-left: 2px solid #f8f8f0 !important;
            }
            
            .code-block-wrapper .CodeMirror-cursor {
                border-left: 2px solid #AEAFAD;
            }
            
            .code-block-wrapper .CodeMirror-selected {
                background: #44475a;
            }
            
            /* ===== Colores de sintaxis Dracula ===== */
            .code-block-wrapper .cm-s-dracula .cm-keyword { color: #ff79c6 !important; }
            .code-block-wrapper .cm-s-dracula .cm-string { color: #f1fa8c !important; }
            .code-block-wrapper .cm-s-dracula .cm-number { color: #bd93f9 !important; }
            .code-block-wrapper .cm-s-dracula .cm-comment { color: #6272a4 !important; font-style: italic; }
            .code-block-wrapper .cm-s-dracula .cm-variable { color: #f8f8f2 !important; }
            .code-block-wrapper .cm-s-dracula .cm-variable-2 { color: #50fa7b !important; }
            .code-block-wrapper .cm-s-dracula .cm-def { color: #50fa7b !important; }
            .code-block-wrapper .cm-s-dracula .cm-operator { color: #ff79c6 !important; }
            .code-block-wrapper .cm-s-dracula .cm-builtin { color: #8be9fd !important; }
            .code-block-wrapper .cm-s-dracula .cm-atom { color: #bd93f9 !important; }
            .code-block-wrapper .cm-s-dracula .cm-property { color: #50fa7b !important; }
            .code-block-wrapper .cm-s-dracula .cm-type { color: #8be9fd !important; }
            .code-block-wrapper .cm-s-dracula .cm-meta { color: #f8f8f2 !important; }
            .code-block-wrapper .cm-s-dracula .cm-qualifier { color: #8be9fd !important; }
            .code-block-wrapper .cm-s-dracula .cm-tag { color: #ff79c6 !important; }
            .code-block-wrapper .cm-s-dracula .cm-attribute { color: #50fa7b !important; }
        `;
    ...
    /**
     * Inicializa el editor CodeMirror para un bloque específico
     */
    initializeCodeEditor(blockId) {
        console.log(`[CodeBlock] Inicializando editor para ${blockId}...`);
        ...
        const deleteBtn = block.querySelector('.code-delete-btn');
        
        console.log(`[CodeBlock] Elementos:`, {
        ...
        // 2. Sincronizar selector con el modo recuperado
        if (languageSelector && initialMode) {
            languageSelector.value = initialMode;
        }
        ...
        try {
            ...
            // Event listener: Cambio de lenguaje
            languageSelector.addEventListener('change', (e) => {
                const newMode = e.target.value;
                console.log(`[CodeBlock] Cambiando modo a: ${newMode}`);
            ...
            copyBtn.addEventListener('click', async (e) => {
                ...
                try {
                    ...
                    this.notifications.success('Código copiado al portapapeles');
                } catch (err) {
            ...
            // Event listener: Eliminar bloque
            deleteBtn.addEventListener('click', (e) => {
                e.preventDefault();
                e.stopPropagation();
            ...
            editor.on('change', () => {
                ...
                block.setAttribute('data-mode', currentMode);
            ...
            this.notifications.error('Error al crear el editor de código: ' + error.message);
        }
    }
    ...
    /**
     * Método fallback para copiar cuando clipboard API no está disponible
     */
    ...
    insertHTML(html) {
        ...
        if (selection.rangeCount > 0) {
            let range = selection.getRangeAt(0); // Cambiado a let
            range.deleteContents();
